...
from backend.app.api import health, models, system, tools
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    async def lifespan(app: FastAPI):
        ...
        registry, executor, traces = build_tool_system(config, app.state.model_manager, logger)
    ...
    app = FastAPI(title="GeoAgent", version="0.3.0", lifespan=lifespan)
